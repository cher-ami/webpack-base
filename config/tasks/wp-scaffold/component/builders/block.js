...
const debug = require("debug")("config:scaffold-block")
...
const _blockBuilder = ({ blockPath, blockName, blockTitle }) => {
  ...
  // scaffold controller
  createFile({
    templateFilePath: `${paths.wpTemplatesPath}/block/blockController.php.template`,
...
const buildBlock = () => {
  return new Promise(async (resolve) => {
    let wpFolder = `${paths.wpTheme}/block`
