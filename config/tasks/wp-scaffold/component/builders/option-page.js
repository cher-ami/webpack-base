...
const debug = require("debug")("config:scaffold-option")
...
const _optionPageBuilder = ({ pagePath, pageName, pageTitle }) => {
  ...
  // scaffold controller
  createFile({
    templateFilePath: `${paths.wpTemplatesPath}/option-page/PageOption.php.template`,
  ...
  // scaffold controller
  createFile({
    templateFilePath: `${paths.wpTemplatesPath}/option-page/PageRestController.php.template`,
  ...
  // scaffold setup
  createFile({
    templateFilePath: `${paths.wpTemplatesPath}/option-page/setup.php.template`,
