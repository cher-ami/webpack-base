...
const _postTypeBuilder = ({
  ...
  createFile({
    templateFilePath: `${paths.wpTemplatesPath}/post-type/PostType.php.template`,
  ...
  // scaffold controller
  createFile({
    templateFilePath: `${paths.wpTemplatesPath}/post-type/PostTypeRestController.php.template`,
  ...
  // scaffold setup
  createFile({
    templateFilePath: `${paths.wpTemplatesPath}/post-type/setup.php.template`,
...
const buildPostType = () => {
  return new Promise(async (resolve) => {
     ...
     * Ask questions
     */
    let postTypeFolder = `${paths.wpTheme}/postType`
